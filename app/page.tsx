            ...
            <Group className="my-16" wrap="nowrap" gap={0}>
                ...
                <Stack className="w-1/2 z-10" gap="xl" justify="center">
                    <Box className="text text-white text-left md:w-4/5">
                        <Text className="text-6xl font-heading animate-staggered-text-up opacity-0 [--slidein-delay:300ms]">Hello! I am</Text>
                        <Text className="text-9xl text-red-400 font-heading animate-staggered-text-up opacity-0 [--slidein-delay:500ms]">Keith.</Text>
