            ...
            {skillsChunk.map((chunk, chunkIndex) => (
                ...
                >
                    {chunk.map((skill, index) => {
                        const absoluteIndex =
                            chunkIndex * itemsPerChunk + index;
                        return (
                            <Box
                                key={absoluteIndex}
                            ...
                            >
                                ...
                                >
                                    {/* front */}
                                    <Stack
                                        className="absolute inset-0 h-full w-full rounded-xl [backface-visibility:hidden] p-5"
                                        justify="center"
                                        align="center"
                                    >
                                        <Image
                                        ...
                                        />
                                        <Text className="font-semibold text-2xl text-gray-200">
                                            {skill.name}
                                        </Text>
                                    </Stack>
                                    {/* back */}
                                    <Stack
                                        className="absolute inset-0 h-full w-full rounded-xl text-center [transform:rotateY(180deg)] [backface-visibility:hidden] p-5"
                                        justify="flex-start"
                                        align="center"
                                    >
                                        <Text className="font-semibold text-3xl mb-2 text-gray-200">
                                            {skill.name}
                                        </Text>
                                        <Text className="font-sans text-lg text-pretty text-center text-gray-200">
                                            {skill.description}
                                        </Text>
                                    </Stack>
                                </Box>
